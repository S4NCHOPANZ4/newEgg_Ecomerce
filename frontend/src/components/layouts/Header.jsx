...
import icon from "../../assets/newEgg.svg"
      ...
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between ">
          ...
          <div className="w-[50%] relative">
            ...
            <AiOutlineSearch
              size={30}
              className="absolute right-2 top-1.5 cursor-pointser"
            />

            {searchTerm && searchTerm.length !== 0 ? (
              <div className="absolute min-h-[30vh] w-[100%] bg-slate-50 shadow-sm-2 z-[9] p-1  rounded-b-md">
                {searchData &&
                  searchData.map((i, index) => {
                    ...
                    return (
                      <Link key={index} to={`/product/${Product_name}`}>
                        <div className="hover:bg-black hover:bg-opacity-20 w-full flex  items-center mb-2 mt-2 p-1 rounded-md">
                          <img
        ...
        >
          ...
          <div onClick={() => setDropDown(!dropDown)}>
            <div className="relative h-[60px] mt-[10px] w-[270px] hidden 1000px:block">
              ...
              <button
                className={`
                text-white h-[100%] w-full flex justify-between items-center pl-10 font-sans text-lg font-[500] select-none rounded-t-md`}
              >
                All Categories
              </button>
              ...
              <IoIosArrowDown
                size={20}
                className="text-white absolute right-2 top-4 cursor-pointer"
          ...
          <div className="flex">
            <div className={`${styles.normalFlex}`}>
              ...
              >
                ...
                <span className="absolute right-0 top-0 rounded-full bg-orange-400 w-4 h-4 right p-0 m-0 text-white font-mono text-[12px] leading-tight text-center">
